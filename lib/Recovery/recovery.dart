              ...
              Column(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      color: _progressValue.value >= 1.0 ? Color(0xFFFF5858) : Color(0xFFFF5858),
            ...
            children: [
              SizedBox(
                ...
                child: CircularProgressIndicator(
                  ...
                  strokeWidth: 30,
                  backgroundColor: Color(0xFFC2FFC7),
                  valueColor: AlwaysStoppedAnimation<Color>(
                    _progressValue12Hours.value >= 1.0 
                      ? Color(0xFF16C47F)
              ...
              Column(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      color: _progressValue12Hours.value >= 1.0 ? Color(0xFF16C47F) : Color(0xFF16C47F),
                      fontWeight: FontWeight.bold,
                      fontSize: 16,
                    ),
                    textAlign: TextAlign.center,
              ...
              Column(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      color: _progressValue60Days.value >= 1.0 ? Color(0xFF7695FF) : Color(0xFF7695FF),
                      fontWeight: FontWeight.bold,
                      fontSize: 16,
                    ),
                    textAlign: TextAlign.center,
