      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              const Text("A New", style: TextStyle(fontSize: 35, fontWeight: FontWeight.bold)),
              const Text("Journey Begins", style: TextStyle(fontSize: 35, fontWeight: FontWeight.bold)),
              ...
              GestureDetector(
                ...
                child: commonCard(
                  ...
                  vertical: screenHeight * 0.015,   // 🟢 Required Parameter
