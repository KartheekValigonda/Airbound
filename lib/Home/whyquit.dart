...
class Whyquit extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Why Quit Smoking?'),
        centerTitle: true,
      ),
        ...
        child: Column(
          ...
          children: [
            ...
            _buildReasonCard(
              ...
              description:
              'No more smoky smell on clothes or breath. Your loved ones will thank you, and you’ll feel more confident in social settings.',
              imageUrl:
